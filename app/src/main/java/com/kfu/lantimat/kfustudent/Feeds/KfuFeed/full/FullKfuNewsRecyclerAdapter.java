...
public class FullKfuNewsRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private Context context;
    private ArrayList<FullNewsItem> mList;

    public FullKfuNewsRecyclerAdapter(Context context, ArrayList<FullNewsItem> itemList) {
